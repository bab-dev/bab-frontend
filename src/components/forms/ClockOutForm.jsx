...
import ActivitiesWorkedDialog from "components/dialogs/ActivitiesWorkedDialog.jsx";
import FormField from "../FormField.jsx";
import FormActions from "../FormActions.jsx";
const ClockOutForm = ({ onCancelClick }) => {
  const [idVolunteer, setIDVolunteer] = useState("");

  const [showActivitiesWorkedDialog, setShowActivitiesWorkedDialog] =
    useState(false);
  ...
  const closeAllDialogs = () => {
    setShowActivitiesWorkedDialog(false);
    onCancelClick();
  };
  return (
    <Box
    ...
    >
      ...
      <FormActions
        isCreate
        isSignUp
        onClickonCancelClick={closeAllDialogs}
        onClickSubmit={handleSubmit(() => setShowActivitiesWorkedDialog(true))}
      />
      <ActivitiesWorkedDialog
        open={showActivitiesWorkedDialog}
        setOpen={setShowActivitiesWorkedDialog}
        idVolunteer={idVolunteer}
        onCancelClick={closeAllDialogs}
      />
    </Box>
  );
};
